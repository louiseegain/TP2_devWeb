...
<?php
    ...
    <div class='carte' style='background-color:white; width:500px; height:400px; border-radius:10px; padding:10px; margin:10px; '>
        ...
        Prénom : <input  style='position:relative; width: 100px;' type=text name=prenom value='".$annonce->getPrenom()."'></br>
        Mail : <input  style='position:relative; width: 200px;' type=mail name=mail value='".$annonce->getEmail()."'></br>
        Téléphone : <input  style='position:relative; width: 200px;' type=number name=telephone value='".$annonce->getTel()."'></br>
